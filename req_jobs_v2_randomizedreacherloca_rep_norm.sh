#!/bin/bash
#SBATCH --job-name=d_v2_sdh_rr_10_rep_norm
...
#SBATCH --output=/home/ruism/projects/def-rsdjjana/ruism/Dreamer_v2_SDH/results/randomizedreacherloca_v2_rep_norm_state_dist_10_seeds/%A-%a.out
#SBATCH --error=/home/ruism/projects/def-rsdjjana/ruism/Dreamer_v2_SDH/results/randomizedreacherloca_v2_rep_norm_state_dist_10_seeds/%A-%a.err

set -e -o pipefail

# Top-level results dir on Lustre
BASE_SAVE_DIR="$HOME/projects/def-rsdjjana/ruism/Dreamer_v2_SDH/results/randomizedreacherloca_v2_rep_norm_state_dist_10_seeds"
...
python -u "$DREAMER_SRC/dreamer.py" \
  ...
  --algo Dreamerv2 \
  --exp-name randomizedreacherloca_v2_rep_norm_state_dist_10_seeds \
  --train \
  --loca-all-phases \
  --buffer-size 2500000 \
